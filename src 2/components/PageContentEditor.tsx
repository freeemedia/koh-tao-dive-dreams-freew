...
const PAGE_DEFINITIONS: Record<string, ContentItem[]> = {
  ...
  'contact': [
    ...
    { section_key: 'footer_line_1', content_value: '© 2026 Diving Asia. All rights reserved. Powered by One Media Asia @ www.onemedia.asia', content_type: 'textarea', label: 'Footer Line 1' },
