...
class KTD_API_Client {
    ...
    public function __construct() {
        $this->base_url = rtrim( get_option( 'ktd_api_url', 'https://www.divinginasia.com' ), '/' );
    ...
    public function get_bookings( array $filters = [] ): array|WP_Error {
        $url      = $this->base_url . '/api/admin-bookings';
    ...
    public function patch_booking( string $id, array $updates ): array|WP_Error {
        $url      = $this->base_url . '/api/admin-bookings?id=' . urlencode( $id );
